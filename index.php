					...
					<div class="product-slider">
						<div class="product-slider">
							<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
								...
								?>
								<div class="item">
									<div class="card h-100 text-center" style="width: 260px; margin: auto;">
									...
									<div class="card-body">
										<h6 class="card-title">
										<a href="product-details.php?pid=<?php echo htmlentities($row['id']); ?>" class="text-dark text-decoration-none">
